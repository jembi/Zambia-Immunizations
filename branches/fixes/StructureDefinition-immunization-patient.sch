...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'http://openhie.org/fhir/zambia-immunizations/StructureDefinition/administrative-sex']) &gt;= 1">extension with URL = 'http://openhie.org/fhir/zambia-immunizations/StructureDefinition/administrative-sex': minimum cardinality of 'extension' is 1</sch:assert>
