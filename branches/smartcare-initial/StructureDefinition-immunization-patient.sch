...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'http://openhie.org/fhir/zambia-immunizations/StructureDefinition/born-in-zambia']) &gt;= 1">extension with URL = 'http://openhie.org/fhir/zambia-immunizations/StructureDefinition/born-in-zambia': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://openhie.org/fhir/zambia-immunizations/StructureDefinition/born-in-zambia']) &lt;= 1">extension with URL = 'http://openhie.org/fhir/zambia-immunizations/StructureDefinition/born-in-zambia': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'http://openhie.org/fhir/zambia-immunizations/StructureDefinition/structure-map']) &gt;= 1">extension with URL = 'http://openhie.org/fhir/zambia-immunizations/StructureDefinition/structure-map': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://openhie.org/fhir/zambia-immunizations/StructureDefinition/structure-map']) &lt;= 1">extension with URL = 'http://openhie.org/fhir/zambia-immunizations/StructureDefinition/structure-map': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:birthDate">
      ...
      <sch:assert test="count(f:extension[@url = 'http://openhie.org/fhir/zambia-immunizations/StructureDefinition/is-estimated-date-of-birth']) &lt;= 1">extension with URL = 'http://openhie.org/fhir/zambia-immunizations/StructureDefinition/is-estimated-date-of-birth': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:value) &lt;= 1">value: maximum cardinality of 'value' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
